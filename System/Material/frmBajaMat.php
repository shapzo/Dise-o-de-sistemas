...
<body background="../../img/ImgWallpAutors.jpg">
    ...
    <header class="contenedor">
        ...
        global $conexion;
        $sql = "SELECT * FROM material WHERE estatus = 'Alta' ORDER BY id_material ASC";
        $ejecucionSql = @mysqli_query($conexion, $sql);
        $menus = "";
        while ($registro = @mysqli_fetch_array($ejecucionSql, MYSQLI_ASSOC)) {
            $menus .= "<option value= $registro[titulo]>$registro[id_material]</option>";
        }
        ?>

        <form action="../../controller/Material.php" method="post">

            <div class="form-group">
                <label class="form-label" for="id">material</label>
