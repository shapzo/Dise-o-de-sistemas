...
<body background="../../img/ImgWallpAutors.jpg">
    ...
    <header class="contenedor">
        ...
        global $conexion;
        $sql = "SELECT * FROM material_externo WHERE estatus = 'baja' ORDER BY titulo ASC";
        $ejecucionSql = @mysqli_query($conexion, $sql);
        $menus = "";
        while ($registro = @mysqli_fetch_array($ejecucionSql, MYSQLI_ASSOC)) {
            @$menus .= "<option value= $registro[id_editorial]>$registro[titulo]</option>";
        }
        ?>
        ...
        <form action="../../controller/MaterialExterno.php" method="post">
            ...
            <div class="form-group">
                <label class="form-label" for="id">Material externo</label>
