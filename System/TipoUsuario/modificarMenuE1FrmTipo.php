...
<body>
    ...
    <header class="contenedor">
            ...
            <dir style="width: 65%;">
                <div class="row" id="box-search">
                    <div class="thumbnail text-center">
                        ...
                        <div class="caption">
                            <h1>
                                <span class="badge badge-pill badge-dark spam1">Modificar datos de tipo de usuario</span>
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        global $conexion;
        $sql = "SELECT * FROM tipodeusuario ORDER BY id_tipo_usuario ASC";
        $ejecucionSql = @mysqli_query($conexion, $sql);
        $opcion = "";
        while ($registro = @mysqli_fetch_array($ejecucionSql, MYSQLI_ASSOC)) {
            @$opcion .= "<option value= $registro[id_tipo_usuario]>$registro[id_tipo_usuario]</option>";
        }
        ?>
        <form action="modificarMenuE2FrmTipo.php" method="post">
